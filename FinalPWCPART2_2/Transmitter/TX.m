...
%%%%   Generating CRC generation 16 bits 
...
Paralle_To_Serial_WithOutPilot= Paralle_To_Serial(129:1:end);
for l=1:length(Paralle_To_Serial_WithOutPilot)/Nsc
    CP(l,:)=Paralle_To_Serial_WithOutPilot(l*Nsc-19:1:l*Nsc);
end
%8.The CPs inserts
Adding_Cp_WithData=Paralle_To_Serial_WithOutPilot;
